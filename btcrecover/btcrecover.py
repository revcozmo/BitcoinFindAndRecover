            ...
            if True:
                ...
                if est_secs_per_password:
                    ...
                    if unskipped_passwords_counted > 0:
                        ...
                        f1 = open(temp + "/UpdatingTotal.tmp", "w+")
                        f1.write(msg)
                        f1.close()
...
def main():
    ...
    if not args.no_eta:
        ...
        if l_savestate or not have_progress:
            ...
            temp = os.environ["TEMP"]
            #f1 = open(temp + "/WorkFolder.tmp", "r")
            #WorkDir = f1.read()
            f1 = open(temp + "/ETA.tmp", "w+")
            f1.write(str(eta_seconds))
            f1.close()
            f2 = open(temp + "/Count.tmp", "w+")
            f2.write(str(passwords_count))
            f2.close()
